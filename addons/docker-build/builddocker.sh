...
DOCKERBUILDARGS+=(--build-arg "CI_COMMIT_SHA=$CI_COMMIT_SHA")
DOCKERBUILDARGS+=(--build-arg "CI_COMMIT_REF_NAME=$CI_COMMIT_REF_NAME")
DOCKERBUILDARGS+=(--build-arg "CI_PIPELINE_ID=$CI_PIPELINE_ID")
DOCKERBUILDARGS+=(--build-arg "CI_COMMIT_TIMESTAMP=$CI_COMMIT_TIMESTAMP")
DOCKERBUILDARGS+=(--build-arg "WEBHARE_VERSION=$WEBHARE_VERSION")
