...
//@ts-expect-error -- It's marked readonly
...
Promise.withResolvers ||= function <T>(): PromiseWithResolvers<T> {
  ...
  // @ts-expect-error `resolve` and `reject` are assigned synchronously, which isn't picked up by the TypeScript compiler (see
