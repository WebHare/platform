...
export { qS, qR, qSA, FormControlElement, isFormControl } from './impl/tree';
...
export { focus, register, registerMissed, TakeFocusEvent } from '../../modules/system/js/dompack/src/components';
