...
interface WrappedJSONromWRDSetting {
  "^$wrdtype": 'json';
  json: string;
}

type WrappedFromWRDSetting = WrappedObjectFromWRDSetting | WrappedJSONromWRDSetting;
...
function returnWRDObject(value: object) {
  switch ((value as WrappedFromWRDSetting)["^$wrdtype"]) {
    ...
    case "json":
      return JSON.parse((value as WrappedJSONromWRDSetting).json);
    default:
      return value;
  }
}
