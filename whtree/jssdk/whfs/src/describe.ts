...
const membertypenames: Array<MemberType | null> =
  [null, null, "string", null, "instant", "file", "boolean", "integer", "float", "money", null, "whfsRef", "array", "whfsRefArray", "stringArray", "richTextDocument", "intExtLink", null, "instance", "url", "composedDocument", "hson", null, "record", "image", "plainDate"];
