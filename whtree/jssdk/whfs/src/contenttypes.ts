...
class WHFSTypeAccessor<ContentTypeStructure extends object = object> implements InstanceDataAccessor<ContentTypeStructure> {
  ...
  async set(id: number, data: ContentTypeStructure, options?: InstanceSetOptions): Promise<void> {
    ...
    const objinfo = await openWHFSObject(0, id, undefined, false, "setInstanceData", false, false); //TODO should we derivce InstanceSetOptions from OpenWHFSObjectOptions ? but how does that work with readonly skip/fail/update ?
