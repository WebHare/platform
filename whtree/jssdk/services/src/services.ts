...
export { ResourceDescriptor, isResourceDescriptor, mapExternalWHFSRef, unmapExternalWHFSRef, exportFileAsFetch, type ExportOptions, type ExportedResource, type ResourceSource, type ResizedImage } from "./descriptor";
