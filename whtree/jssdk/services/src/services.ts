...
export { ResourceDescriptor, isResourceDescriptor, mapExternalWHFSRef, unmapExternalWHFSRef, exportFileAsFetch, type ExportOptions, type ExportedResource, type ResourceSource } from "./descriptor";
