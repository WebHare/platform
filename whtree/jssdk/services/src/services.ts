...
export { ResourceDescriptor, isResourceDescriptor, mapExternalWHFSRef, unmapExternalWHFSRef, type ExportOptions, type ExportedResource, type ResourceSource } from "./descriptor";
