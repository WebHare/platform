...
export type HostRuntimeMessage
  ...
  | { tollium_iframe: "screenResult"; id: number; button: string }
  | { tollium_iframe: "focus" }
  | { tollium_iframe: "theme"; name: string };
...
export type GuestMessage
  ...
  | { tollium_iframe: "runSimpleScreen"; id: number; type: "error" | "warning" | "info" | "verify" | "confirm" | "question"; message: string; title?: string }
