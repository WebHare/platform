...
if [ -n "$ONLYBASECONFIG" ]; then
  ...
  TS_NODE_PROJECT="$WEBHARE_DATAROOT/tsconfig.json" node --enable-source-maps -r "${BASH_SOURCE%/*}/../../js/internal/generated/resolveplugin.js" "${BASH_SOURCE%/*}/../internal/updateconfigfile.ts" $NODB
else
