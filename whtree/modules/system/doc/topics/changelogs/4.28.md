...
- The implementations `widgetedit` (`<screen implementation="p:widgetedit">` and `WidgetEditScreenBase`) and `widgetextension` (`<tabsextension implementation="p:widgetextension">` and `WidgetEditExtensionBase`) have been deprecated. A widget edit screen should be replaced with a tabsextension (see https://forum.webhare.dev/t/editing-widgets-editfragment-editscreen-and-editcomponent-deprecated/33) and for a widget tabsextension the implementation attribute can be removed.
