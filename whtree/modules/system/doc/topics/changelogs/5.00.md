...
- `mod::consilio/lib/catalog.whlib` has been removed and all public functions in `mod::consilio/lib/queries.whlib` and
  `mod::consilio/lib/queuemgmt.whlib` have now been deprecated, use the equivalent functions in `mod::consilio/lib/api.whlib` instead.
