...
- You can now store form results for custom non-webtool forms using `InitializeStoreResultsHandler` and view the results
  using `RunFormResultsDialog`. See [customforms.md](https://www.webhare.dev/reference/forms/customforms)
