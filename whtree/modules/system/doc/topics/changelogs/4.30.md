...
- RTD (internal) links can now be intercepted by overriding %WebDesignBase::ResolveLink and you can now use `ResolveLink` wherever you need to resolve an int/extlink record yourself.
