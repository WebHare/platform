...
- You should add `consilio:sitecontent` to catalogs that will receive Publisher frontend sites to prevent races during
  setup of the catalogs. (a future version of WebHare may even require this)
