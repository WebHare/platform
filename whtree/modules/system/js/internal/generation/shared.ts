...
export const generatorBanner = "/* This file is auto-generated, do not modify but regenerate using `wh apply dev`.\n    Use the dev module's browser for examples on how to use these types. */\n\n/* eslint-disable */\n";
export const generateForConfig = ["config", "extracts", "wrd", "openapi", "ts"] as const;
export const generateForDev = ["db", "schema", "ts-dev"] as const;
export const generatorTypes = [...generateForConfig, ...generateForDev] as const;
