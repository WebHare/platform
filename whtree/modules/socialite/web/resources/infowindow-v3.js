...
function toddGM_InfoWindow(map, overlay)
{
  // Stops all processing of an event.
  //
  this.cAbortEvent = function(e)
  {
    if (e.preventDefault)
      e.preventDefault();
    e.cancelBubble = true;
...
toddGM_InfoWindow.prototype = new google.maps.OverlayView();

toddGM_InfoWindow.prototype.onAdd = function toddGM_InfoWindow_onAdd()
{
...
toddGM_InfoWindow.prototype.draw = function toddGM_InfoWindow_draw()
{
}

toddGM_InfoWindow.prototype.Reposition = function toddGM_InfoWindow_Reposition()
{
  if (this.overlay)
  {
    // Reposition the info window
    var iconanchor = this.overlay.toddicon.icon.anchor;
    var infoanchor = this.overlay.toddicon.infoOffset;
...
toddGM_InfoWindow.prototype.onRemove = function toddGM_InfoWindow_onRemove()
{
  // Clean up
