...
import type { MutexManagerLinkType, MutexListStatusResponse } from "@webhare/services/src/mutex";
...
export async function listLocks(): Promise<MutexListStatusResponse> {
  ...
  return statusrequest as MutexListStatusResponse;
}
