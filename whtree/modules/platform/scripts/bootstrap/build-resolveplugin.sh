...
TARGETDIR="jssdk/ts-esbuild-runner/dist" # doesn't seem correct to use this location, but eases the transition. maybe we should gather all generated core stuff into a whtree/dist/ folder"
mkdir -p "$TARGETDIR"
