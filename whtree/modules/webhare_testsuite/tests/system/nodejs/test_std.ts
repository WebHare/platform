...
function testCompare() {
  ...
  test.eq(-1, std.compare(Temporal.Instant.from("2025-02-02T12:00:00Z"), new Date("2025-02-02T14:00:00Z")));
  test.eq(1, std.compare(new Date("2025-02-02T14:00:00Z"), Temporal.Instant.from("2025-02-02T12:00:00Z")));
