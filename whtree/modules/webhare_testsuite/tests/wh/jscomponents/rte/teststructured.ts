...
test.registerTests(
  [
    ...
    , {
      ...
      , test: function(doc, win) {
        var body = win.rte.getEditor().getBody();
    ...
    , {
      ...
      , test: function(doc, win) {
        ...
        var testlocator = new domlevel.Locator(rte.getBody());
    ...
    , {
      ...
      , test: async function(doc, win) {
        ...
        var li = rte.getBody().querySelector('li');
