  ...
  , async function()
    {
      ...
      await test.load(testinfo.beacondoc + "/?wh-debug=connect");
  ...
  , async function()
    {
      ...
      await test.load(testinfo.url + "?now=2000-01-15T12:34:56&wh-debug=connect");
  ...
  , async function()
    {
      ...
      // Load the form page
      await test.load(testinfo.beaconform + "?wh-debug=connect");
