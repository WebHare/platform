...
import { ResourceDescriptor, toResourcePath, type BackendEvent, subscribe, BackendEventSubscription, IntExtLink } from "@webhare/services";
...
export function subscribeToEventStream(masks: string | string[]) {
