  ...
  */
  ...
  let esbuild_configuration =
      ...
      , publicPath: bundle.bundleconfig.assetbaseurl || `/.ap/${bundle.outputtag.split(':').join('.')}/`
        // This is a workaround for broken stacktrace resolving caused by esbuild generating ../../../../ paths but running out of path componetns when building relative URLs in stack-mapper in stacktrace-gps
