/* global define */
/* eslint no-restricted-globals:0, no-self-assign:0, semi:0, no-redeclare: 0 */

//IE11/Edge specific fixes/polyfills which improve general compatibility with common WebHare JS code
//as this code is compiled, we'll disable some checks for easier maintenance

/////////////////////////////////////////////////////////////////////////////////
//
// github/fetch  (compiled version)
//
...
///////////////////////////////////////////////////////////////////////////////
//
// closest, matches. source https://developer.mozilla.org/en-US/docs/Web/API/Element/closest
//
if (typeof Element !== 'undefined' && !Element.prototype.matches)
{
  Element.prototype.matches = Element.prototype.msMatchesSelector ||  Element.prototype.webkitMatchesSelector;
  //it's probably IE11, so polyfill contains with a version that DOES support textNodes while we're at it
  Document.prototype.contains = Element.prototype.contains = HTMLElement.prototype.contains = function(child)
  {
  ...
  {
    let set = force===undefined ? !this.contains(token) : force;
    this[set?'add':'remove'](token);
    return !!set;
  };
...
{
  var generateInsertList = function(nodes)
  {
    if(nodes.length==1)
      return typeof nodes[0]==='string' ? document.createTextNode(nodes[0]) : nodes[0];

    var frag = document.createDocumentFragment();
    nodes.forEach(function(node) { frag.appendChild(typeof node === 'string' ? document.createTextNode(node) : node); });
    return frag;
  }
  Element.prototype.before = function()
  {
    var nodes = generateInsertList([].slice.call(arguments))
    if(this.parentNode)
...
/////////////////////////////////////////////////////////////////////////////////
//
// lifaon74/url-polyfill https://github.com/lifaon74/url-polyfill/blob/master/url-polyfill.js
//
+(function() {
...
(function(global) {
  ...
  //Arnold: moved iterator checks into the functions to give babel time to register Symbol.iterator
...
//
// end of URL/URLSearchParams polyfill
//
///////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////
//
// Polyfill template.content

if(!("content" in document.createElement("template")))
{
  var setupTemplateElement = function(template)
  {
    //ADDME support nested templates ?
  ...
  var setupTemplateElements = function()
  {
    Array.from(document.querySelectorAll("template")).forEach(setupTemplateElement);
  }

  if(document.readyState == "interactive" || document.readyState == "complete")
    setupTemplateElements();
  else
    document.addEventListener("DOMContentLoaded", setupTemplateElements);
}

///////////////////////////////////////////////////////////////////////////////////
//
// Polyfill DocumentFragment.firstElementChild (eeded by template code)
// based on https://gist.github.com/tuespetre/f91b91bfd4dabab04e57a6db187c0c34
if(document.createDocumentFragment().firstElementChild !== null)
{
...
///////////////////////////////////////////////////////////////////////////////////
//
// Polyfill CSS.escape for IE11
// based on https://mths.be/cssescape v1.5.1 by @mathias | MIT license
if(!window.CSS)
  window.CSS={};
